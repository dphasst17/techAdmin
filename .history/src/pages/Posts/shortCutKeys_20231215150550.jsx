const ShortKey = () => {
    ...
    return <div className="shortKey-container md:w-4/5 h-auto flex flex-wrap justify-around bg-slate-500 rounded-lg px-2">
        ...
        <div className="more w-1/5 h-auto flex flex-col my-2">
            <span className="w-full text-white font-semibold my-2"><div className="w-[40px] h-[20px] flex justify-center items-center text-slate-900 bg-slate-400 rounded-lg">Ctrl</div> + B : Font Bold</span>
            <span className="w-full text-white font-semibold my-2"><div className="w-[40px] h-[20px] flex justify-center items-center text-slate-900 bg-slate-400 rounded-lg">Ctrl</div> + I : Italics</span>
            <span className="w-full text-white font-semibold my-2"><div className="w-[40px] h-[20px] flex justify-center items-center text-slate-900 bg-slate-400 rounded-lg">Ctrl</div> + U : Underline</span>
