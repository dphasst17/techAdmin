        ...
        <div className="formDetail md:w-[60vw] h-[50vh] bg-slate-500 z-40 flex flex-col justify-around items-center pt-12 md:pt-0 pb-5 rounded-xl">
            ...
            <div className="formView w-full h-[90%] flex flex-col justify-between overflow-y-auto">
                <form className="w-full h-auto">
                    <button className="w-[100px] h-[30px] rounded-lg bg-green-200 mx-2" type="button" onClick={handleClick}>Add column</button>
                    <div className="formProduct w-full h-full min-h-[400px] flex flex-wrap justify-center items-start px-5">
                        {inputs.map((input) => (
                            <div className="w-4/5 h-[40px] flex justify-around" key={input}>
                                ...
                                />
                                <select className="w-[30%] h-full rounded-lg" name="select" {...register(`option${input}`, { required: false })}>
