                    ...
                    <div className="formProduct w-[98%] h-auto min-h-[50px] flex flex-wrap justify-center items-start px-5">
                        {inputs.map((input) => (
                            <div className="w-full md:w-4/5 h-auto lg:h-[40px] flex flex-wrap justify-around my-4" key={input}>
                                ...
                                <input 
                                    className="w-[45%] lg:w-1/5 h-[40px] lg:h-full my-2 rounded-lg outline-none px-2"
                                    name={`limit-${input}`}
                                    {...register(`input-demo${input}`, { required: false })}
                                    placeholder="Character limit..."
                                />
                                <input
                                    className={`w-[45%] lg:w-[10%] h-[40px] lg:h-full ${err[`order-${input}`] ? 'border-solid border-red-500 border-[1px]' :'border-transparent'} my-2 rounded-lg outline-none px-2`}
                                    name={`name-${input}`}
