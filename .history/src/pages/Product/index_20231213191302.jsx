...
function Product() {
    ...
    return <div className="p-container w-screen sm:w-full h-auto flex flex-col pt-2 pr-0 sm:px-2 z-10">
        ...
        {dataProduct !== null && <div className="w-full h-[50px] flex items-center">
            ...
            <div onClick={() => { setAddImg(!addImg) }} className="addImgProduct w-[100px] h-4/5 mx-2 flex justify-center items-center rounded-lg bg-slate-500 text-slate-100 font-semibold cursor-pointer">ADD TYPE</div>
