    ...
    return <div className="p-container w-screen sm:w-full h-auto flex flex-col pt-2 pr-0 sm:px-2 z-10">
        ...
        {dataProduct !== null && <div className="w-full h-[50px] flex items-center">
            ...
            {delBtn && <div onClick={HandleDelProduct}
                className="delBtn animate-showDiv w-[70px] h-[45px] active:scale-75 transition-all cursor-pointer"
            >
                <img src={deleteIcon} className="w-full h-full object-cover" alt="this is add icon" />
            </div>
            }
        </div>}
        ...
        {addType === true && <FormAddNew props={{ setAddNew }} />}
