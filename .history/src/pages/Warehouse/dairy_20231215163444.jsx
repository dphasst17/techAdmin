...
const Diary = () => {
    ...
    return <>
        ...
        <div className="diary w-full h-auto flex flex-wrap justify-evenly">
            <div className="titleTable w-full xl:w-4/5 h-auto min-h-[100px] md:h-[50px] bg-slate-600 rounded-lg flex flex-wrap ">
                <span className="w-4/5 md:w-2/5 h-full flex items-center justify-center text-[18px] text-white font-semibold">Name product</span>
