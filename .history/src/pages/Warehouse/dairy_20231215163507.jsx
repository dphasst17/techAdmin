...
const Diary = () => {
    ...
    return <>
        ...
        <div className="diary w-full h-auto flex flex-wrap justify-evenly">
            <div className="titleTable w-full xl:w-4/5 h-auto min-h-[50px] md:h-[50px] bg-slate-600 rounded-lg flex flex-wrap ">
                <span className="w-4/5 md:w-2/5 h-2/4 md:h-full flex items-center justify-center text-[18px] text-white font-semibold">Name product</span>
                <span className="w-[15%] h-2/4 md:h-full flex items-center justify-center text-[18px] text-white font-semibold">Person</span>
                <span className="w-[15%] h-2/4 md:h-full flex items-center justify-center text-[18px] text-white font-semibold">Date</span>
                <span className="w-[15%] h-2/4 md:h-full flex items-center justify-center text-[18px] text-white font-semibold">Count</span>
                <span className="w-[15%] h-2/4 md:h-full flex items-center justify-center text-[18px] text-white font-semibold">Status</span>
            </div>
