        ...
        <div>
          <div className="relative z-20 inline-block">
            <select
              name="#"
              id="#"
              className={`relative z-20 inline-flex appearance-none  py-1 pl-3 pr-8 text-sm ${props.dark === true ? 'text-slate-800 bg-slate-100' :'text-slate-100 bg-slate-800'} rounded-lg my-2 font-medium outline-none`}
            >
